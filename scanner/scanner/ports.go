...
// PortInfo contains IANA port registration information
type PortInfo struct {
	ServiceName string
	Description string
}

// ianaPortDatabase is the IANA Service Name and Transport Protocol Port Number Registry
// Source: https://www.iana.org/assignments/service-names-port-numbers
var ianaPortDatabase = map[int]PortInfo{
	...
	211: {"914c-g", "Texas Instruments 914C/G Terminal IANA assigned this well-formed service name as a replacement fo..."},
	212: {"anet", "ATEXSSTR"},
	213: {"ipx", "IPX"},
	...
	513: {"login", "remote login a la telnet; automatic authentication performed based on priviledged port numbers an..."},
	514: {"shell", "cmd like exec, but automatic authentication is performed as for login server"},
	515: {"printer", "spooler"},
	516: {"videotex", "videotex"},
	517: {"talk", "like tenex link, but across machine - unfortunately, doesn't use link protocol (this is actually ..."},
	518: {"ntalk", ""},
	519: {"utime", "unixtime"},
	...
	887: {"iclcnet-svinfo", "ICL coNETion server info IANA assigned this well-formed service name as a replacement for iclcnet..."},
	...
	1067: {"instl-boots", "Installation Bootstrap Proto. Serv. IANA assigned this well-formed service name as a replacement ..."},
	1068: {"instl-bootc", "Installation Bootstrap Proto. Cli. IANA assigned this well-formed service name as a replacement f..."},
	...
	1138: {"encrypted-admin", "encrypted admin requests IANA assigned this well-formed service name as a replacement for encrypt..."},
	...
	1385: {"atex-elmd", "Atex Publishing License Manager IANA assigned this well-formed service name as a replacement for ..."},
	...
	1454: {"interhdl-elmd", "interHDL License Manager IANA assigned this well-formed service name as a replacement for interhd..."},
	...
	1556: {"veritas-pbx", "VERITAS Private Branch Exchange IANA assigned this well-formed service name as a replacement for ..."},
	...
	2347: {"redstorm-find", "Game Announcement and Location IANA assigned this well-formed service name as a replacement for r..."},
	2348: {"redstorm-info", "Information to query for game status IANA assigned this well-formed service name as a replacement..."},
	...
	3121: {"pcmk-remote", "The pacemaker remote (pcmk-remote) service extends high availability functionality outside of the..."},
	...
	3938: {"dbcontrol-agent", "Oracle dbControl Agent po IANA assigned this well-formed service name as a replacement for dbcont..."},
	...
	3986: {"mapper-ws-ethd", "MAPPER workstation server IANA assigned this well-formed service name as a replacement for mapper..."},
	...
	4060: {"dsmeter-iatc", "DSMETER Inter-Agent Transfer Channel IANA assigned this well-formed service name as a replacement..."},
	...
	4140: {"cedros-fds", "Cedros Fraud Detection System IANA assigned this well-formed service name as a replacement for ce..."},
	...
	4151: {"menandmice-noh", "Men & Mice Remote Control IANA assigned this well-formed service name as a replacement for menand..."},
	...
	4184: {"universe-suite", "UNIVERSE SUITE MESSAGE SERVICE IANA assigned this well-formed service name as a replacement for u..."},
	...
	4360: {"matrix-vnet", "Matrix VNet Communication Protocol IANA assigned this well-formed service name as a replacement f..."},
	4368: {"wxbrief", "WeatherBrief Direct"},
	4369: {"epmd", "Erlang Port Mapper Daemon"},
	4370: {"elpro-tunnel", "ELPRO V2 Protocol Tunnel IANA assigned this well-formed service name as a replacement for elpro_t..."},
	...
	4570: {"deploymentmap", "Service to distribute and update within a site deployment information for Oracle Communications S..."},
	...
	4646: {"dots-signal", "Distributed Denial-of-Service Open Threat Signaling (DOTS) Signal Channel Protocol. The service n..."},
	...
	4901: {"flr-agent", "FileLocator Remote Search Agent IANA assigned this well-formed service name as a replacement for ..."},
	...
	5195: {"ampl-lic", "The protocol is used by a license server and client programs to control use of program licenses t..."},
	...
	5586: {"att-mt-sms", "Planning to send mobile terminated SMS to the specific port so that the SMS is not visible to the..."},
	...
	6301: {"bmc-ctd-ldap", "BMC CONTROL-D LDAP SERVER IANA assigned this well-formed service name as a replacement for bmc_ct..."},
	...
	6444: {"sge-qmaster", "Grid Engine Qmaster Service IANA assigned this well-formed service name as a replacement for sge_..."},
	6445: {"sge-execd", "Grid Engine Execution Service IANA assigned this well-formed service name as a replacement for sg..."},
	...
	6507: {"bdir-priv", "BoKS Dir Server, Private Port IANA assigned this well-formed service name as a replacement for bd..."},
	6508: {"bdir-pub", "BoKS Dir Server, Public Port IANA assigned this well-formed service name as a replacement for bdi..."},
	...
	6629: {"nexgen-aux", "Secondary, (non ANDI) multi-protocol multi-function interface to     the Allied ANDI-based family..."},
	...
	7201: {"dlip", "DLIP"},
	7202: {"pon-ictp", "Inter-Channel Termination Protocol (ICTP) for multi-wavelength PON     (Passive Optical Network) ..."},
	...
	10003: {"documentum-s", "EMC-Documentum Content Server Product IANA assigned this well-formed service name as a replacemen..."},
	...
	12302: {"rads", "Remote Administration Daemon (RAD) is a system service that offers secure, remote, programmatic a..."},
	...
	16789: {"cadsisvr", "This server provides callable services to mainframe External Security Managers from any TCP/IP pl..."},
	...
	17223: {"isa100-gci", "ISA100 GCI is a service utilizing a common interface between an ISA100 Wireless gateway and a cli..."},
	...
	31948: {"iceedcp-tx", "Embedded Device Configuration Protocol TX IANA assigned this well-formed service name as a replac..."},
	31949: {"iceedcp-rx", "Embedded Device Configuration Protocol RX IANA assigned this well-formed service name as a replac..."},
	...
	38800: {"sruth", "Sruth is a service for the distribution of routinely-       generated but arbitrary files based o..."},
	...
	44818: {"EtherNet-IP-2", "EtherNet/IP messaging IANA assigned this well-formed service name as a replacement for EtherNet/I..."},
	...
	46998: {"spremotetablet", "Connection between a desktop computer or server and a signature tablet to capture handwritten sig..."},
...
// GetPortInfo returns IANA registration info for a port
func GetPortInfo(port int) (PortInfo, bool) {
	info, ok := ianaPortDatabase[port]
	return info, ok
}

// getDefaultServiceName returns the IANA service name for a port
func getDefaultServiceName(port int) string {
	if info, ok := ianaPortDatabase[port]; ok {
